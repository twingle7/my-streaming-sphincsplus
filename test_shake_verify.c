/*
 * Simple test for double-pass signing and verification using SHAKE
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
    printf("Testing double-pass signing and verification with SHAKE...\n");

    /* Use SHAKE-128f */
    #if TS_SUPPORT_SHAKE
    const struct ts_parameter_set *ps = &ts_ps_shake_128f_simple;
    #else
    printf("SHAKE not supported\n");
    return 1;
    #endif
