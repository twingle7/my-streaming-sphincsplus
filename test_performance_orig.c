/*
 * Quick Performance Test for Tiny SPHINCS+ (Original Version)
 * Quick test with single parameter set for comparison with modified version
 */
...
int main(void) {
    printf("=================================================================\n");
    printf("  Tiny SPHINCS+ Quick Performance Test (Original Version)\n");
    printf("=================================================================\n");
